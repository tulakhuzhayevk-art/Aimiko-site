...
const advantages = [
  ...
  { icon: BatteryCharging, title: "Запас хода 60+ км", text: "Надёжные аккумуляторы EVE, DMEGC, BMS DALY с честным знаком." },
  { icon: Zap, title: "Цены ниже рынка", text: "Прямые поставки. Дешевле, чем у многих конкурентов." },
